...
if(NOT "/home/roboy/roboy_team_ws22/w22-test-bench/catkin_ws/devel/include " STREQUAL " ")
  set(bench_INCLUDE_DIRS "")
  set(_include_dirs "/home/roboy/roboy_team_ws22/w22-test-bench/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bench' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roboy/roboy_team_ws22/w22-test-bench/catkin_ws/src/bench/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/roboy/roboy_team_ws22/w22-test-bench/catkin_ws/devel/lib;/home/roboy/roboy3/devel/lib;/opt/ros/noetic/lib)
